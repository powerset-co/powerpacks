...
echo "  search search-profile search-company search-sql search-contacts build-local-search-index powerset powerset-login powerset-set sales-nav-search build-outbound"
