...
echo "  search search-sql search-contacts build-local-search-index powerset powerset-login powerset-set feedback update-powerpacks sales-nav-search build-outbound"
