...
rm -rf "$TARGET/.claude/skills/search-network-jd"
cp -R "$REPO_ROOT/packs/search/skills/search-network-jd" "$TARGET/.claude/skills/search-network-jd"
...
rm -rf "$TARGET/container/skills/search-network-jd"
cp -R "$REPO_ROOT/packs/search/skills/search-network-jd" "$TARGET/container/skills/search-network-jd"
