...
cp -R "$REPO_ROOT/packs/search/skills/extract-search-query" "$TARGET/.claude/skills/extract-search-query"
...
cp -R "$REPO_ROOT/packs/search/skills/extract-search-query" "$TARGET/container/skills/extract-search-query"
