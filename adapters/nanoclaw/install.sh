...
rm -rf "$TARGET/.claude/skills/extract-search-query"
cp -R "$REPO_ROOT/skills/search-network" "$TARGET/.claude/skills/search-network"
cp -R "$REPO_ROOT/skills/extract-search-query" "$TARGET/.claude/skills/extract-search-query"

rm -rf "$TARGET/container/skills/search-network"
rm -rf "$TARGET/container/skills/extract-search-query"
cp -R "$REPO_ROOT/skills/search-network" "$TARGET/container/skills/search-network"
cp -R "$REPO_ROOT/skills/extract-search-query" "$TARGET/container/skills/extract-search-query"
...
rm -rf "$TARGET/powerpacks/contracts"
rm -rf "$TARGET/powerpacks/evals"
...
cp -R "$REPO_ROOT/tasks" "$TARGET/powerpacks/tasks"
cp -R "$REPO_ROOT/contracts" "$TARGET/powerpacks/contracts"
cp -R "$REPO_ROOT/evals" "$TARGET/powerpacks/evals"
