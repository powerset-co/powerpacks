...
class BootstrapNetworkFromExportsTests(unittest.TestCase):
    ...
    def test_generate_operator_bundle_uses_full_operator_uuid(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(manifest["counts"]["directory_rows"], 1)
            self.assertEqual(manifest["counts"]["linkedin_connections_cached_rows"], 1)
            self.assertTrue((output_root / "operators/patrick/resolution/directory.csv").exists())
            ...
            self.assertEqual(directory_rows[0]["source_id"], "17d602f7-f073-40b4-97a1-dba00c574442")
