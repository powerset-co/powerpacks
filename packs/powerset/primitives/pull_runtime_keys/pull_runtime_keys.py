...
steps need OpenAI and Parallel. All three credentials are pulled from the
...
def build_parser() -> argparse.ArgumentParser:
    ...
    pull = sub.add_parser("pull", help="fetch Modal, OpenAI, and Parallel keys from the API into .env")
