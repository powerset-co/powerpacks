...
6. `format_people` — `people_harmonic_all.csv`-compatible output.
...
- `people_harmonic_all.csv` — downstream-compatible person shape with Twitter handle and provider raw JSON columns.
