...
| [`messages/models.py`](messages/models.py) | `MessageContactRow` (the 19-column `contacts.csv` row model), the `owns_columns` split, and the typed channel/stage manifest payloads | — | — |
