...
Emits the fixed CSV consumed by Powerpacks' local browser reviewer and Messages
...
def main() -> None:
    ...
    build = sub.add_parser("build", help="Flatten + bucket research artifacts into the local review CSV")
