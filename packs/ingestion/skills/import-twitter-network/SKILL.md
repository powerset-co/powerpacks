...
Pipeline stages: RapidAPI Twitter crawl → local heuristic score → OpenAI MOE expert evaluation → free parallel LinkedIn pre-resolution → parallel RapidAPI LinkedIn validation → `people_harmonic_all.csv` formatting.
